...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8" />
	<title>LeftSidebar Clip ${clipName }</title>
	<!--[if lt IE 9]>
...
<!-- 	<body>    -->
	...
	<div class="container" style="${clipBackgroundColor };">
		...
		<div id="leftsidebar" class="four columns" style="${clipBackgroundColor };">
		
			${leftSidebarHTMLCode }
		
		</div>
		
		<div id="main" class="twelve columns" align="center" style="${clipBackgroundColor };">
