<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %> <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %> <%@ taglib uri="http://ckeditor.com" prefix="ckeditor" %> <%@page import="com.ckeditor.CKEditorConfig"%>  
  ...
  <!-- Primary Page Layout
	================================================== --> 
  </head><body scroll='no' style='overflow: hidden' leftmargin='0' topmargin='0' rightmargin='0' bottommargin='0' marginwidth='0' marginheight='0'><form:form name='clipForm' method='post' modelAttribute='clip' action='nextClip' ><div class="container" style="background-color: #CC4435"> 
    <div id="header" class="sixteen columns" style="background-color: #CC4435">   
     <p> Ent&ecirc;te</p>  
    </div> 
    <div id="main" class="sixteen columns" align="center" style="background-color: #CC4435">   
     <h1 style="text-align: center;"> <span style="color:#afeeee;">Test Sidebars 7</span></h1>  
    </div> 
    <div id="footer" class="sixteen columns" style="background-color: #CC4435">   
     <p> Pied de page</p>  
    </div> 
