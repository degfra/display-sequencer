...
<head>
  ...
  ================================================== -->
	<meta charset="utf-8" />
	<title>Left Sidebar Base Template</title>
	<!--[if lt IE 9]>
...
<!-- <body scroll="no" style="overflow: hidden" leftmargin="0" topmargin="0"
	...
	<div class="container">
		...
		<div id="leftsidebar" class="four columns">
			...
			<form:textarea path="leftSidebarEditor" cols="80" id="leftSidebarEditor" name="leftSidebarEditor" rows="10"></form:textarea>
		
		</div>
		
		<div id="main" class="twelve columns" align="center">
	...
	//<![CDATA[
		...
		CKEDITOR.replace( 'leftSidebarEditor',
			{
				sharedSpaces :
				{
					top : 'sharedToolbar',
