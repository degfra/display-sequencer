...
<!-- 	<body>    -->
	...
	<div class="container" style="${clipBackgroundColor };">
		...
		<div id="leftsidebar" class="three columns" style="${clipBackgroundColor };">
		
			${leftSidebarHTMLCode }
		
		</div>
		
		<div id="main" class="ten columns" align="center" style="${clipBackgroundColor };">
			
			${mainHTMLCode }
			
		</div>
		
		<div id="rightsidebar" class="three columns" style="${clipBackgroundColor };">
		
			${rightSidebarHTMLCode }
