<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %> <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %> <%@ taglib uri="http://ckeditor.com" prefix="ckeditor" %> <%@page import="com.ckeditor.CKEditorConfig"%>  
  ...
  <title>Sidebars Base Clip Preview</title> 
  <!--[if lt IE 9]>
  ...
  <!-- Primary Page Layout
	================================================== --> 
  </head><body scroll='no' style='overflow: hidden' leftmargin='0' topmargin='0' rightmargin='0' bottommargin='0' marginwidth='0' marginheight='0'><form:form name='clipForm' method='post' modelAttribute='clip' action='nextClip' ><div class="container" style="background-color: #CC4935"> 
    <div id="header" class="sixteen columns" style="background-color: #CC4935">   
     <p> Ent&ecirc;te</p>  
    </div> 
    <div id="leftsidebar" class="three columns" style="background-color: #CC4935">   
     <p> Colonne de gauche</p>  
    </div> 
    <div id="main" class="ten columns" align="center" style="background-color: #CC4935">   
     <h2 style="text-align: center;"> <span style="color:#fff0f5;">Test Sidebars4</span></h2>  
    </div> 
    <div id="rightsidebar" class="three columns" style="background-color: #CC4935">   
     <p> Colonne de droite</p>  
    </div> 
    <div id="footer" class="sixteen columns" style="background-color: #CC4935">   
     <p> Pied de page</p>  
    </div> 
